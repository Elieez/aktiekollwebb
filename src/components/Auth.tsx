        ...
        <div className="relative" ref={containerRef}>
            ...
            >
                {user.googleAvatar ? (
                    ...
                    <span className="flex h-full w-full items-center justify-center bg-bg4 text-ink">
            ...
            {open && (
                <div className="absolute right-0 top-full mt-2 z-50 w-52 overflow-hidden rounded-xl border border-white/[0.07] bg-bg2 shadow-xl">
                    ...
                    <div className="border-b border-white/[0.07] px-3 py-2.5">
                        <p className="truncate text-xs font-medium text-ink">{displayName || user.email}</p>
